...
volt.files <- data.frame(path =dir(pattern = "*.txt", path = "C:/Users/field/Desktop/Voltage_emails", full.names = T), stringsAsFactors = F)
volt.files$Datetime <- as.POSIXct(substr(volt.files$path, 39, stop = 53), format = "%Y%m%d-%H%M%S")
