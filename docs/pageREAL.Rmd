...
test <- merge(test, gen_locs[,c("recv", "location")], by = "recv")

par(mar=c(5.1,2.1,2.1,6.1))
...
last_week <- merge(last_week, gen_locs[,c("recv", "location")], by = "recv")
...
gen_loc_stats <- merge(gen_locs[,c("recv", "location")], last_download, by = "location", all.x = T)

gen_loc_stats <- gen_loc_stats[order(gen_loc_stats$last_download, decreasing = T),]
