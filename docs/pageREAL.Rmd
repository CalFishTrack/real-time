...
3. Once valid fish visits have been determined, any visit that has less than 5 detections AND a detection density of less than 4 / (16.6 * PRI) (e.g., for a 10 sec PRI, at least 1.45 detections per minute of time)

4. Detections fall between release time and 150% of battery life: For detections to be assigned to an actual released fish, the detections need to fall between the release time of that fish, and the release time + 150% of the estimated tag life for that fish's tag.
