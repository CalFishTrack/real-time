...
TECKNO_files$dayes <- as.Date(apply(data.frame(TECKNO_files$x, stringsAsFactors = F), MARGIN = 1, FUN = substr, nchar(TECKNO_files$x)-23, nchar(TECKNO_files$x)-14), "%Y_%m_%d")
