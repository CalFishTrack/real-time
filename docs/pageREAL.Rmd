...
test <- aggregate(detects_beacon$DateTime_PST, by = list(recv = detects_beacon$recv, hour = format(detects_beacon$DateTime_PST, format = "%Y-%m-%d %H")), FUN = length)
...
```{r plot alltime receiver beacon detections, echo=FALSE, warning=FALSE, message=FALSE,  results = "hide"}
...
```{r plot just last weeks receiver beacon detections, echo=FALSE, warning=FALSE, message=FALSE,  results = "hide"}
## And for last week
