...
```{r print figure of fish detections at Benicia, message = FALSE, error= FALSE, fig.height = 6, fig.width = 10, out.extra='style="background-color: #000000; padding:3px"', ,fig.cap="2.3 Detections at Benicia Bridge"}
