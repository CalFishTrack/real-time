...
# **Hatchery Fall-run Chinook salmon Paired Release**
...
Telemetry Study Template for this study can be found [here](https://github.com/CalFishTrack/real-time/blob/master/data/Telemetry Study Summary Framework__Coleman Hatchery FCS Paired Net Pen_FY2021.pdf?raw=true)
...
study <- "USFWS_FCSPairedNetPen_2021"
##################################################################################################################
...
if (nrow(detects_study) == 0){
  ...
  #######################################################################
    detects_study$Release <- "Upstream"
    ...
    detects_study[detects_study$release_time > as.POSIXct("2021-03-25"), "Release"] <- "Downstream"
  #######################################################################
