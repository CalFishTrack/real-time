...
htmltools::img(src = knitr::image_uri("../data/mill_ck.jpg"))#, 
               #alt = 'logo', 
...
detects_study <- read.csv("detects_DeerCk-Wild-2018.csv", stringsAsFactors = F)
...
test <- fread("detects_DeerCk-Wild-2018.csv", stringsAsFactors = FALSE)
