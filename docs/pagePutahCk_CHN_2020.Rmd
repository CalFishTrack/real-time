...
```{r print figure of fish detections at Benicia, message = FALSE, fig.height = 6, fig.width = 10, out.extra='style="background-color: #000000; padding:3px"', ,fig.cap="2.1 Detections at Benicia Bridge"}
