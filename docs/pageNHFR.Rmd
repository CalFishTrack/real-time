...
test <- fread("C:/Users/field/Desktop/Real-time data massaging/products/Study_detection_files/detects_Nimbus-Fall-2018.csv", stringsAsFactors = FALSE, colClasses = c(DateTime_PST = "character", RelDT = "character"))
