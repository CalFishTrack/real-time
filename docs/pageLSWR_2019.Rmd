...
Additional details on study can be found [here](https://github.com/CalFishTrack/real-time/blob/master/data/TelemetryStudySummary_NOAA_LSNFH_Winter-run.pdf?raw=true)
