...
detects_study <- read.csv("C:/Users/field/Desktop/Real-time data massaging/products/Study_detection_files/detects_ColemanLateFall_2020.csv", stringsAsFactors = F)
...
if (nrow(detects_study) == 0){
  ...
  beacon_by_day <- merge(beacon_by_day, gen_locs[,c("location", "general_location")], by = "location", all.x = T)
