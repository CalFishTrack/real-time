...
htmltools::img(src = knitr::image_uri("../data/FeatherRiver_BC_Beach5.JPG"))#, 
               #alt = 'logo', 
...
Telemetry Study Template for this study can be found [here](https://github.com/CalFishTrack/real-time/blob/master/data/Telemetry_Study_Summary_NOAA_Feather_Hatchery_Spring-run.pdf?raw=true)
