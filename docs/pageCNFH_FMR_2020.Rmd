...
study_tagcodes <- tagcodes[tagcodes$StudyID == "CNFH_FMR_2020",]
...
if (nrow(study_tagcodes) == 0){
  ...
  study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2020-05-17"), "Release"] <- "Week 2"
...
detects_study <- fread(paste(file.path(Sys.getenv("USERPROFILE"),"Desktop",fsep="\\"), "\\Real-time data massaging\\products\\Study_detection_files\\detects_CNFH_FMR_2020.csv", sep = ""))
