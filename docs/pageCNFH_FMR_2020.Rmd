...
# **Hatchery-origin fall-run Chinook salmon May Release**
...
Telemetry Study Template for this study can be found [here](https://github.com/CalFishTrack/real-time/blob/master/data/Telemetry_Study_Summary_MayPulseFlow.pdf?raw=true)
...
detects_study[detects_study$release_time > as.POSIXct("2020-05-17"), "Release"] <- "Week 2"
