...
*Sacramento real-time receiver deployed 2018-02-01, data current as of `r latest`*
...
barp <- barplot(height= daterange2$unique_tags, col="gray",  names.arg= daterange2$Day, xlab = "", ylab = "Number of fish arrivals per day", ylim = c(0,max(daterange2$unique_tags, na.rm = T)*1.5), las = 2, xlim=c(0,nrow(daterange2)+1.5), cex.lab = 1.5)
