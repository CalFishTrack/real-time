...
htmltools::img(src = knitr::image_uri("../data/Rice_Photo1.jpg"))#, 
               #alt = 'logo', 
...
Telemetry Study Template for this study can be found [here](https://github.com/CalFishTrack/real-time/blob/master/data/Telemetry_Study_Summary_RiceProject_2020.pdf?raw=true)
...
if (nrow(study_tagcodes) == 0){
  ...
  study_tagcodes[study_tagcodes$RelDT == as.POSIXct("2020-05-30 22:00:00", tz = "Etc/GMT+8"), "Release"] <- "May Release - Nimbus control"
  study_tagcodes[study_tagcodes$RelDT == as.POSIXct("2020-05-30 22:01:00", tz = "Etc/GMT+8"), "Release"] <- "May Release - Coleman control"
  study_tagcodes[study_tagcodes$RelDT == as.POSIXct("2020-05-30 21:59:00", tz = "Etc/GMT+8"), "Release"] <- "May Release - Rice field rear"
...
```{r print figure of fish detections at Tower, message = FALSE, fig.height = 6, fig.width = 10, warning = F, out.extra='style="background-color: #000000; padding:3px"',fig.cap="2.2 Detections at Tower Bridge (downtown Sacramento) versus Sacramento River flows at Wilkins Slough"}
...
detects_study <- fread(paste(file.path(Sys.getenv("USERPROFILE"),"Desktop",fsep="\\"), "\\Real-time data massaging\\products\\Study_detection_files\\detects_UCDRice2020.csv", sep = ""), colClasses = c(DateTime_PST = "character", RelDT = "character"))
