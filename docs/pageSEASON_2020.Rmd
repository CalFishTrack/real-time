...
```{r print plot of season total survival, out.extra='style="background-color: #000000; padding:3px"', echo = FALSE, warning=FALSE, message = FALSE, fig.cap="1.1 Survival to Benicia for all major Chinook salmon tagging efforts (n > 100). Hover cursor over points to see release group."}
...
benicia_rel <- benicia_rel[benicia_rel$RelDT > "2020-01-01",]
...
```{r print plot of season total delta survival, out.extra='style="background-color: #000000; padding:3px"', echo = FALSE, warning=FALSE, message = FALSE, fig.cap="1.2 Through-Delta survival (City of Sacramento to Benicia) for all major Chinook salmon tagging efforts (n > 100). Hover cursor over points to see release group."}
library(CDECRetrieve)
library(plotly)
...
## Label "ALL" release for any study with just 1 record
benicia_rel[benicia_rel$StudyID %in% names(which(table(benicia_rel$StudyID) ==1)),"Release"] <- "ALL"
wlk_flow <- as.data.frame(cdec_query("RVB", "25", "D", as.Date(min(benicia_rel$RelDT))-7, as.Date(max(benicia_rel$RelDT))+14))
...
## Historic survival to Benicia estimates (PROVISIONAL DATA)
```{r Benicia survival pic, echo=FALSE, cache=TRUE}
htmltools::img(src = knitr::image_uri("../data/surv_to_Benicia.png"))#, 
               #alt = 'logo', 
...
## Historic through-Delta survival estimates (PROVISIONAL DATA)
```{r Delta survival pic, echo=FALSE, cache=TRUE}
htmltools::img(src = knitr::image_uri("../data/Delta_surv.png"))#, 
               #alt = 'logo', 
               #style = 'position:absolute; top:0px; right:0px; width:100px;')
```
