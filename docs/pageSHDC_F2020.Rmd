...
study_tagcodes <- tagcodes[tagcodes$StudyID == "SHDC_F2020",]
...
detects_study <- read.csv("C:/Users/field/Desktop/Real-time data massaging/products/Study_detection_files/detects_SHDC_F2020.csv", stringsAsFactors = F)
