...
Telemetry Study Template for this study can be found [here](https://github.com/CalFishTrack/real-time/blob/master/data/Telemetry_Study_Summary_Sac_River_Green_Sturgeon_2020_post.pdf?raw=true)
...
detects_study <- fread("C:/Users/field/Desktop/Real-time data massaging/products/Study_detection_files/detects_Juv_Green_Sturgeon_2019.csv", stringsAsFactors = F, colClasses = c(DateTime_PST = "character", RelDT = "character"))
