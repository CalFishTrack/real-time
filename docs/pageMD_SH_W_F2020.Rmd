...
# **Mill and Deer Creek wild steelhead, Fall Releases**
...
study <- "MillDeerCK_SH_Wild_F2020"
##################################################################################################################
...
detects_study$Release <- "MillCk_RST"
detects_study[detects_study$release_location == ("DeerCk_RST"), "Release"] <- "DeerCk_RST"
