...
The dataset title is: [JSATS California Fish Tracking](https://oceanview.pfeg.noaa.gov/erddap/tabledap/FED_JSATS_detects.html). There are many available fields so click on the question mark bubble for an explanation of each field.
