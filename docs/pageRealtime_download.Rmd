...
Alternatively, data can be imported directly into R. To do so, please follow instructions [here.](https://github.com/CalFishTrack/real-time/blob/master/data/How_to_download_realtime_data_into_R.pdf?raw=true) 
