...
study_tagcodes <- tagcodes[tagcodes$StudyID == "SB-Spring-2018",]
study_tagcodes$Release_week <- NA

study_tagcodes[study_tagcodes$RelDT < as.POSIXct("2018-04-10"), "Release_week"] <- "Week 1"
study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2018-04-10") & study_tagcodes$RelDT < as.POSIXct("2018-04-22"), "Release_week"] <- "Week 2"
study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2018-04-22") & study_tagcodes$RelDT < as.POSIXct("2018-04-28"), "Release_week"] <- "Week 3"
study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2018-04-28") & study_tagcodes$RelDT < as.POSIXct("2018-05-05"), "Release_week"] <- "Week 4"
study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2018-05-05") & study_tagcodes$RelDT < as.POSIXct("2018-05-10"), "Release_week"] <- "Week 5"
study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2018-05-10"), "Release_week"] <- "Week 6"
...
detects_study <- read.csv("detects_SB-Spring-2018.csv", stringsAsFactors = F)
...
if (nrow(detects_study) == 0){
  ...
  detects_study <- merge(detects_study, tagcodes[,c("TagID_Hex", "RelDT", "StudyID", "Release_week")], by.x = "TagCode", by.y = "TagID_Hex")
...
test <- fread("detects_SB-Spring-2018.csv", stringsAsFactors = FALSE)
