...
study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2018-04-28"), "Release_week"] <- "Week 4"
...
tagcodes[tagcodes$RelDT > as.POSIXct("2018-04-28"), "Release_week"] <- "Week 4"
...
if (nrow(test) == 0){
  ...
  for (j in unique(study_tagcodes$Release_week)) {
