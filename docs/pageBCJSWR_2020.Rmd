...
study_tagcodes <- tagcodes[tagcodes$StudyID == "BC_Jumpstart_2020",]
...
detects_study <- fread(paste(file.path(Sys.getenv("USERPROFILE"),"Desktop",fsep="\\"), "\\Real-time data massaging\\products\\Study_detection_files\\detects_BC_Jumpstart_2020.csv", sep = ""))
