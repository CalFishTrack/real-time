...
study_tagcodes <- tagcodes[tagcodes$StudyID == "DeerCk_SH_Wild_S2019",]
...
if (nrow(study_tagcodes) == 0){
  ...
  #study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-05-11"), "release"] <- "Week 2"
  #study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-04-14") & study_tagcodes$RelDT < as.POSIXct("2019-04-20"), "release"] <- "Week 1"
  #study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-04-20") & study_tagcodes$RelDT < as.POSIXct("2019-04-27"), "release"] <- "Week 2"
  #study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-04-27") & study_tagcodes$RelDT < as.POSIXct("2019-05-04"), "release"] <- "Week 3"
  #study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-05-04") & study_tagcodes$RelDT < as.POSIXct("2019-05-11"), "release"] <- "Week 4"
  #study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-05-11") & study_tagcodes$RelDT < as.POSIXct("2019-05-18"), "release"] <- "Week 5"
  
    study_tagcodes$release <- "Week 1"
# study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-04-14") & study_tagcodes$RelDT < as.POSIXct("2019-04-21"), "release"] <- "Week 1"
    study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-04-21") & study_tagcodes$RelDT < as.POSIXct("2019-04-28"), "release"] <- "Week 2"
    study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-04-28") & study_tagcodes$RelDT < as.POSIXct("2019-05-05"), "release"] <- "Week 3"
    study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-05-05") & study_tagcodes$RelDT < as.POSIXct("2019-05-11"), "release"] <- "Week 4"
    study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-05-11") & study_tagcodes$RelDT < as.POSIXct("2019-05-19"), "release"] <- "Week 5"
  study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-05-19") & study_tagcodes$RelDT < as.POSIXct("2019-05-26"), "release"] <- "Week 6"
    study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-05-26") & study_tagcodes$RelDT < as.POSIXct("2019-06-02"), "release"] <- "Week 7"
    study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-06-02") & study_tagcodes$RelDT < as.POSIXct("2019-06-09"), "release"] <- "Week 8"
...
```{r print figure of fish detections at Butte, echo = FALSE, message = FALSE, fig.height = 6, fig.width = 10}
...
detects_study <- read.csv("detects_DeerCk_SH_Wild_S2019.csv", stringsAsFactors = F)
...
if (nrow(detects_study) == 0){
  ...
  tag_stats <- merge(tag_stats, 
                     aggregate(list(Last_arrival = detects_study$DateTime_PST), 
                         by= list(general_location = detects_study$general_location),
                         FUN = max), 
                     by = c("general_location"))
  tag_stats <- merge(tag_stats, 
  ...
  for (j in sort(unique(study_tagcodes$release))) {
    ...
    if(nrow(detects_study[detects_study$release == j,]) > 0 ) {
      ...
      tag_stats1 <- merge(tag_stats1, 
                         ...
                         by = c("general_location"))
      tag_stats1 <- merge(tag_stats1, 
                   aggregate(list(Last_arrival = temp$DateTime_PST), 
                       by= list(general_location = temp$general_location), 
                       FUN = max), 
                   by = c("general_location"))
      tag_stats1 <- merge(tag_stats1, 
