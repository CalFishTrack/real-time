...
## 2018-2019 SPRING Season (PROVISIONAL DATA)
...
#study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-04-14") & study_tagcodes$RelDT < as.POSIXct("2019-04-21"), "Release"] <- "Week 1"
    ...
    study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-05-05") & study_tagcodes$RelDT < as.POSIXct("2019-05-12"), "Release"] <- "Week 4"
    study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-05-12") & study_tagcodes$RelDT < as.POSIXct("2019-05-19"), "Release"] <- "Week 5"
...
detects_study <- read.csv("C:/Users/field/Desktop/Real-time data massaging/products/Study_detection_files/detects_DeerCk_SH_Wild_S2019.csv", stringsAsFactors = F)
