...
Telemetry Study Template for this study can be found [here](https://github.com/CalFishTrack/real-time/blob/master/data/Telemetry Study Summary Framework_Butte Creek_2021.pdf?raw=true)
...
if (nrow(detects_study) == 0){
  ...
  #######################################################################
    detects_study$Release <- "Downstream Release"
    ...
    detects_study[detects_study$release_time > as.POSIXct("2021-04-18"), "Release"] <- "Upstream Release"
  #######################################################################
