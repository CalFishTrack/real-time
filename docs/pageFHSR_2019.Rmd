...
study_tagcodes <- tagcodes[tagcodes$StudyID == "Feather_Spring_2019",]
...
if (nrow(study_tagcodes) == 0){
  ...
  study_tagcodes[study_tagcodes$RelDT < as.POSIXct("2018-05-12 12:02:00"), "Release"] <- "Release 2"
...
detects_study <- read.csv("detects_Feather_Spring_2019.csv", stringsAsFactors = F)
