...
# **Mill and Deer Creek wild Chinook salmon, Fall Releases**
...
study_tagcodes <- tagcodes[tagcodes$StudyID == "MillDeerCK_Wild_F2020",]
...
if (nrow(study_tagcodes) == 0){
  ...
  study_tagcodes$Release <- "MillCk_RST"
  study_tagcodes[study_tagcodes$Rel_loc == ("DeerCk_RST"), "Release"] <- "DeerCk_RST"
...
detects_study <- fread("C:/Users/field/Desktop/Real-time data massaging/products/Study_detection_files/detects_MillDeerCK_Wild_F2020.csv", colClasses = c(DateTime_PST = "character", RelDT = "character"))
