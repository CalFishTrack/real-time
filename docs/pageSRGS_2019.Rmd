...
Telemetry Study Template for this study can be found [here](https://github.com/CalFishTrack/real-time/blob/master/data/Telemetry_Study_Summary_Sac_River_Green_Sturgeon.pdf?raw=true)
...
test <- fread("C:/Users/field/Desktop/Real-time data massaging/products/Study_detection_files/detects_Juv_Green_Sturgeon_2018.csv", stringsAsFactors = FALSE)
