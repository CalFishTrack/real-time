...
study_tagcodes <- tagcodes[tagcodes$StudyID == "2019UP_UCD",]
...
if (nrow(study_tagcodes) == 0){
  ...
  study_tagcodes[study_tagcodes$RelDT > as.POSIXct("2019-03-01"), "Release_week"] <- "Week 2"
