...
gen_locs <- read.csv("realtime_locs.csv", stringsAsFactors = F, colClasses = c(DateTime_PST = "character", RelDT = "character"))
...
test <- fread("C:/Users/field/Desktop/Real-time data massaging/products/Study_detection_files/detects_RBDD-2018.csv", stringsAsFactors = FALSE, colClasses = c(DateTime_PST = "character", RelDT = "character"))
