...
study_tagcodes <- tagcodes[tagcodes$StudyID == "MDSH_F2020",]
...
detects_study <- read.csv("C:/Users/field/Desktop/Real-time data massaging/products/Study_detection_files/detects_MDSH_F2020.csv", stringsAsFactors = F)
