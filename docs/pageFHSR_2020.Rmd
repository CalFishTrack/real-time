...
if (nrow(study_tagcodes) == 0){
  ...
  study_tagcodes[study_tagcodes$Rel_loc == "FR_Gridley_Rel", "Release"] <- "Gridley"
...
detects_study <- fread(paste(file.path(Sys.getenv("USERPROFILE"),"Desktop",fsep="\\"), "\\Real-time data massaging\\products\\Study_detection_files\\detects_FR_Spring_2020.csv", sep = ""), colClasses = c(DateTime_PST = "character", RelDT = "character"))
